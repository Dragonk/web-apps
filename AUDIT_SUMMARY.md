...
- PR2: all 1296 mobile missing strings translated to Polish (EN->PL, tokens/markup preserved), followed by contextual QA of confirmed MT errors (tabela, wzorzec, obraz, odrzuć, przenieś). Mobile structural coverage: Document 100%, Presentation 100%, Spreadsheet 100%, Visio 100% (missing=0, placeholders=0). 34 values identical to EN remain (13/4/13/4) — mostly technical terms and short labels, listed for review.
...
- PARTIAL: translation QA (full human linguistic review still recommended), desktop embed/forms identical values.
