...
|---|---|---|---|---|---|---|
| 1 | `i18n-pl/pr1-i18n-validation` | Generic read-only locale parity checker (PEP8, dataclasses) + 12 unit tests incl. missing-locale detection, malformed JSON, nested structure, non-string values, all placeholder conventions, real fixture | 1 | none | PASS (12 tests) | YES WITH REVIEW |
