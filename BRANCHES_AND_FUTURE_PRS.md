...
|---|---|---|---|---|---|---|
| 1 | `i18n-pl/pr1-i18n-validation` | Generic read-only locale parity checker (PEP8, dataclasses) + 9 unit tests incl. missing-locale detection, malformed JSON, nested structure, non-string values, all placeholder conventions, real fixture | 1 | none | PASS (9 tests) | YES WITH REVIEW |
| 2 | `i18n-pl/pr2-polish-mobile` | Mobile PL: 1296 previously missing keys translated (EN->PL), placeholders/markup preserved, 0 missing/0 empty/0 placeholder mismatches on all 4 mobile editors | 2 | PR1 recommended | PASS structural checker; contextual QA corrections applied; broader human review still recommended | NO — human Polish QA |
