...
|---|---|---|---|
| pr1 | `python3 -m unittest discover -s translation/tests -v` | PASS | 9 tests: nested missing/stale/empty/identical, placeholder conventions ({0}, %1, %s, %d, ${x}, {{x}}), empty+non-string values, invalid nested structure, malformed JSON, missing locale file detection, real EuroOffice mobile fixture |
